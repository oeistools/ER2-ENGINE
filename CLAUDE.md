...
assets/             logo.png (README, docs home), logo-dark.png (README in
                    dark mode), logo-mark.png (navbar, favicon), and their
                    SVG sources — all GENERATED by tools/make_logo.py
                    (`make logo`); docs/assets is a symlink to it
